    ...
    public function downloadTemplate(Request $request, string $entity): StreamedResponse|JsonResponse
    {
        $templates = [
            ...
            'departments' => [
                ...
                'samples' => [
                    ['CMN-CORP', 'SITE-SGT', 'ENG', 'Mining Engineering & Technical Support', 'Departemen perencanaan tambang, geoteknik, dan survei pit', 'ACTIVE'],
                    ['CMN-CORP', 'SITE-SGT', 'PROD', 'Mining Operations & Production', 'Departemen operasional penambangan pit batubara', 'ACTIVE'],
                ],
            ],
            'sections' => [
                'headers' => ['company_code', 'department_code', 'site_code', 'code', 'name', 'description', 'status'],
                'samples' => [
                    ['CMN-CORP', 'ENG', 'SITE-SGT', 'SEC-MINE-PLAN', 'Short Term Mine Planning', 'Seksi perencanaan tambang jangka pendek mingguan/bulanan', 'ACTIVE'],
                    ['CMN-CORP', 'PROD', 'SITE-SGT', 'SEC-HAUL-01', 'Coal Hauling & Road Pit 1', 'Seksi pengangkutan batubara dan perawatan jalan tambang', 'ACTIVE'],
                ],
            ],
            'positions' => [
