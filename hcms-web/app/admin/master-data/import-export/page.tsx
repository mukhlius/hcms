...
const ENTITY_CATALOG: EntityMeta[] = [
  ...
  },
  {
    ...
    name: 'Master Jenjang',
    category: 'Organisasi',
    description: 'Katalog kamus nama jenjang standar perusahaan (Senior Group Leader, Junior Supervisor, dll).',
  ...
  },
  {
    ...
    name: 'Uang Perdin',
    category: 'Benefit & Plafon',
    description: 'Tarif uang perjalanan dinas (perdin) harian berdasarkan jenjang jabatan.',
    icon: <PlaneTakeoff className="h-5 w-5 text-blue-600" />,
    iconBg: 'bg-blue-50 dark:bg-blue-950/50',
    columns: ['jenjang', 'amount', 'period_type', 'status'],
  },
  {
    id: 'bantuan-lumpsum',
